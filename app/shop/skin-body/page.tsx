      ...
      <section className="py-20 sm:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <div className="border border-stone-200 bg-stone-50 p-8 sm:p-10">
            ...
            <p className="text-stone-600 font-light leading-relaxed mb-8">Follow Mouna Cosmetics for future skin and body launch updates. Current orders are available through WhatsApp.</p>
