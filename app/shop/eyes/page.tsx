...
export default function EyesPage() {
  ...
  return (
    <PageShell>
      <PageHero
        eyebrow={dictionary.common.eyes}
      ...
      <section className="py-20 sm:py-28 bg-white">
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-stone-200 bg-stone-50 p-8">
            ...
            <a href={getWhatsappOrderLink("Palette bundle")} target="_blank" rel="noopener noreferrer" className="inline-block border border-stone-900 px-6 py-3 text-xs uppercase tracking-[0.22em] text-stone-900 hover:bg-stone-900 hover:text-white transition-colors duration-300">{dictionary.common.askOnWhatsapp}</a>
          </div>
        </div>
      </section>
    </PageShell>
