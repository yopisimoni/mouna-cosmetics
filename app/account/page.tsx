...
export default function AccountPage() {
  ...
  const dashboardSections = [
    {
      title: dictionary.common.orders,
      description: dictionary.common.ordersDesc,
      icon: (
    ...
    {
      title: dictionary.common.profile,
      description: dictionary.common.profileDesc,
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.3}>
    ...
    },
    {
      ...
      description: dictionary.common.wishlistDesc,
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.3}>
    ...
    {
      title: dictionary.common.rewards,
      description: dictionary.common.rewardsDesc,
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.3}>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-stone-600 font-light tracking-wide mt-4 text-sm">
              {dictionary.common.accountComingSoon}
            </p>
          </div>
          ...
          <div className="border border-stone-200 bg-stone-50 p-8 text-center">
            <p className="text-sm font-light text-stone-600 leading-relaxed mb-4">
              {dictionary.common.accountPlaceholder}
            </p>
